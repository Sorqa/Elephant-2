...
public class ShapeMainActivity extends AppCompatActivity {
        ...
        for (Button buttonId : colorBtn) {
            buttonId.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    result_colorbtn.setBackgroundResource(R.drawable.choose_button); //해당아이디 버튼의 배경색을 바꿈
        ...
        for (Button buttonId : shapeBtn) {
            buttonId.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    result_shapebtn.setBackgroundResource(R.drawable.choose_button); //해당아이디 버튼의 배경색을 하양으로 바꿈
        ...
        for (Button buttonId : typeBtn) {
            buttonId.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    result_typebtn.setBackgroundResource(R.drawable.choose_button); //해당아이디 버튼의 배경색을 하양으로 바꿈
    ...
    public void click_result(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), ShapeSearch.class);
